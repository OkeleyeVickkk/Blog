				...
				<div class="bricks-wrapper" data-animate-block>
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/statue-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/statue-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/statue-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/beetle-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/beetle-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/beetle-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/grayscale-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/grayscale-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/grayscale-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/woodcraft-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/woodcraft-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/woodcraft-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/tulips-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/tulips-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/tulips-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/red-and-blue-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/red-and-blue-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/red-and-blue-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/white-lamp-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/white-lamp-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/white-lamp-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/books-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/books-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/books-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/lamp-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/lamp-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/lamp-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/clock-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/clock-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/clock-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/phone-and-keyboard-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/phone-and-keyboard-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/phone-and-keyboard-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
					...
					<article class="brick entry" data-animate-el>
						<div class="entry__thumb">
							<a href="single-standard.html" class="thumb-link">
								<img
									src="<?= requireAssets('images/thumbs/masonry/wheel-600.jpg') ?>"
									srcset="<?= requireAssets('images/thumbs/masonry/wheel-600.jpg') ?> 1x,
									<?= requireAssets('images/thumbs/masonry/wheel-1200.jpg') ?> 2x"
									alt="" />
							</a>
						</div>
						<!-- end entry__thumb -->
