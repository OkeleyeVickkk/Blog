...
if (!isset($this->pageData['removeFooterOnly']) || $this->pageData['removeFooterOnly'] != true): ?>
  ...
  <!-- end s-footer -->
<?php endif; ?>
<script src="<?= requireAssets(filePath: 'js/plugins.js'); ?>"></script>
<script src="<?= requireAssets(filePath: 'js/main.js'); ?>"></script>
</body>
