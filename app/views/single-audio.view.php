			...
			<div class="column lg-12">
				<article class="entry format-standard">
					<header class="entry__header">
						<h1 class="entry__title">Hey, This Is An Audio Post.</h1>
					...
					<div class="entry__media">
						<div class="featured-image">
							<iframe
								...
								frameborder="no"
								allow="autoplay"
								src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/80822997&color=%23dedede&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
						</div>
					</div>
					...
					<div class="content-primary">
						<div class="entry__content">
							<p class="lead">
								...
								ullamco magna amet magna cupidatat qui labore cillum cillum cupidatat fugiat nostrud.
							</p>
							...
							<p class="drop-cap">
								...
								reprehenderit est praesentium impedit maiores incididunt adipisicing veniam velit .
							</p>
							...
							<figure class="alignwide">
								<img
									src="<?= requireAssets('images/sample-1200.jpg') ?>"
									srcset="<?= requireAssets('images/sample-2400.jpg') ?> 2400w,
									 <?= requireAssets('images/sample-1200.jpg') ?> 1200w,
									 <?= requireAssets('images/sample-600.jpg') ?> 600w"
							...
							<p>
								...
								impedit quo minus <a href="http://#">omnis voluptas assumenda est</a> id quod maxime placeat facere possimus, omnis dolor
							...
							<p>
								Odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti dolores et quas molestias excepturi sint
								occaecati cupiditate non provident, similique sunt in culpa. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis
								vestibulum. Nulla vitae elit libero, a pharetra augue laboris in sit minim cupidatat ut dolor voluptate enim veniam consequat
							...
							<p>
								Quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo
							...
							<div class="entry__author-box">
								<figure class="entry__author-avatar">
									<img alt="" src="<?= requireAssets('images/avatars/user-06.jpg') ?>" class="avatar" />
								</figure>
								<div class="entry__author-info">
									...
									<p>
										Pellentesque ornare sem lacinia quam venenatis vestibulum. Nulla vitae elit libero, a pharetra augue laboris in sit minim
										cupidatat ut dolor voluptate enim veniam consequat occaecat.
									</p>
								</div>
							</div>
						</div>
							...
							<ol class="commentlist">
								<li class="depth-1 comment">
									<div class="comment__avatar">
										<img class="avatar" src="<?= requireAssets('images/avatars/user-01.jpg'); ?>" alt="" width="50" height="50" />
									</div>
									...
									<div class="comment__content">
										...
										<div class="comment__text">
											<p>
												...
												expetenda has et. Iudico dictas scriptorem an vim, ei alia mentitum est, ne has voluptua praesent.
											</p>
										</div>
									</div>
								</li>
								...
								<li class="thread-alt depth-1 comment">
									<div class="comment__avatar">
										<img class="avatar" src="<?= requireAssets('images/avatars/user-04.jpg') ?>" alt="" width="50" height="50" />
									</div>
									...
									<div class="comment__content">
										...
										<div class="comment__text">
											<p>
												Sumo euismod dissentiunt ne sit, ad eos iudico qualisque adversarium, tota falli et mei. Esse euismod urbanitas ut sed, et
												duo scaevola pericula splendide. Primis veritus contentiones nec ad, nec et tantas semper delicatissimi.
											</p>
										</div>
									</div>
									...
									<ul class="children">
										<li class="depth-2 comment">
											<div class="comment__avatar">
												<img class="avatar" src="<?= requireAssets('images/avatars/user-03.jpg') ?>" alt="" width="50" height="50" />
											</div>
											...
											<div class="comment__content">
												...
												<div class="comment__text">
													<p>
														Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Duis sed odio sit amet
								...
								<li class="depth-1 comment">
									<div class="comment__avatar">
										<img class="avatar" src="<?= requireAssets('images/avatars/user-02.jpg') ?>" alt="" width="50" height="50" />
									</div>
